...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h3><strong><i class="bi bi-person-heart align-text-bottom"></i> Clientes </strong></h3>
  <div class="btn-toolbar mb-2 mb-md-0">
		<a name="" id="" class="btn btn-primary me-2" href="<?php echo URL_PATH; ?>clientes/formnuevocliente" role="button"><i class="bi bi-plus align-text-bottom"></i> Nuevo Cliente</a>
  </div>
</div>
<!-- ./ Titulo -->
...
<div class="container-fluid">
  <div>
    <table class="table table-striped table-hover	table-borderless align-middle table-responsive" width="100%" id="Table_list_Clientes">
      ...
      <tbody class="table-group-divider">
				<?php  foreach ($lista_clientes as $key => $value) { ?>
				<tr>
					<td><?php echo $value['NombreCompletoCliente'] ; ?></td>
					<td><?php echo ($value['EstadoCliente']) ? '<i class="bi bi-check-circle-fill" style="font-size: 1rem;color:green;"></i>' : '<span class="text-muted fst-italic">Inactivo</span>'; ?></td>
					<td><?php echo $value['ClasificacionCliente']; ?></td>
					<td><?php echo $value['FuenteCreacion']; ?></td>
					<td><?php echo $value['Telefono2Cliente'] ; ?></td>
					<td><?php if($value['ServiciosAbiertos']){?>
								<a tabindex="0" class="btn btn-outline-success btn-sm" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-html="true" data-bs-title="Dismissible popover" data-bs-content='<?php echo $value['ServiciosAbiertos']; ?>'><?php echo $value['CantServicios'];?> Servicios</a>
							<?php } ?>
					</td>
					<td><?php echo $value['Antiguedad'] ; ?> </td>
				</tr>
				<?php } ?>
      </tbody>
    </table>
...
<div class="modal fade"	id="newcliente"	tabindex="-1"	data-bs-backdrop="static"	data-bs-keyboard="false"	role="dialog"	aria-labelledby="modalTitleId"	aria-hidden="true">
	<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"	role="document"	>
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Nuevo Cliente</h5>
				<button type="button"	class="btn-close"	data-bs-dismiss="modal"	aria-label="Close" id="close_modal_newcliente"></button>
			</div>
			<div class="modal-body">
				<div id="alert_intomodal"></div>
				<form id="form_clientenuevo">
					<div class="container-fluid">
							<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-3">
										<div class="list-group" id="list-tab" role="tablist" style="font-size: 0.7em;">

											<li class="list-group-item list-group-item-action" id="list-VIP-list" data-bs-toggle="list" href="#list-VIP" role="tab" aria-controls="list-home" style="font-weight: bold;color:black;background-color: #F9C304;font-size: 1.2em;font-style: italic;" onclick="select_clasificacion(this.id)">
											...
											<li class="list-group-item list-group-item-action" id="list-A-list" data-bs-toggle="list" href="#list-A" role="tab" aria-controls="list-home" style="font-weight: bold;color:black; background-color:#A5D6A7" onclick="select_clasificacion(this.id)">
											...
											<li class="list-group-item list-group-item-action" id="list-B-list" data-bs-toggle="list" href="#list-B" role="tab" aria-controls="list-profile" style="font-weight: bold;color:black;background-color: #AED6F1" onclick="select_clasificacion(this.id)">
											...
											<li class="list-group-item list-group-item-action" id="list-C-list" data-bs-toggle="list" href="#list-C" role="tab" aria-controls="list-messages" style="font-weight: bold;color:black;background-color: #E6EE9C" onclick="select_clasificacion(this.id)">
											...
											<li class="list-group-item list-group-item-action" id="list-D-list" data-bs-toggle="list" href="#list-D" role="tab" aria-controls="list-settings" style="font-weight: bold;color:black;background-color: #E6E6E5" onclick="select_clasificacion(this.id)">
									...
									<div class="col-9">
										<div class="tab-content" id="nav-tabContent">
											<div class="tab-pane fade" id="list-VIP" role="tabpanel" aria-labelledby="list-VIP-list">
												<b style="color:green"><i class="bi bi-gem" style="color:green;margin-right: 4px;font-weight: bold;font-size: 1.2em;"></i> VIP</b>- Clientes que que reciben un trato diferencial por la importancia comercial que tienen para una empresa. Son consumidores que seguro no quieres perder; por eso, es clave hacerlos sentir especiales brindándoles una atención superior
											</div>
											...
											<div class="tab-pane fade" id="list-B" role="tabpanel" aria-labelledby="list-B-list">
											...
											<div class="tab-pane fade" id="list-C" role="tabpanel" aria-labelledby="list-C-list">
											...
											<div class="tab-pane fade" id="list-D" role="tabpanel" aria-labelledby="list-D-list">
												<b style="color:red">Clientes D (Vetado)</b> - Son clientes que no pagan a tiempo, quieren beneficios excesivos, demandan gran cantidad de tiempo, no invierten en sí mismos y siempre consideran que están comprando caro. Por difícil que sea, hay clientes que tiene que despedir.
											</div>
										</div>
									</div>
								</div>
					...
					<fieldset id="direcciones_cliente" disabled>
						<div class="row">
							...
							<h4>Nueva Direccion (Opcional)</h4>
							<div class="col-12 col-md-3 form-group">
								<label for="nombre_direccion">Nombre dirección:</label>
							...
							<div class="col-12 col-md-3 form-group">
								...
								<input type="text" class="form-control form-control-sm direcciones_cliente" id="barrio" required>
								<small class="text-danger" id="barrioError"></small>
							</div>
							<div class="col-12 col-md-8 form-group">
								<label for="direccion">Dirección:</label>
								<input type="text" class="form-control form-control-sm direcciones_cliente" id="direccion" required>
...
<!-- Modal -->
<div class="modal fade" id="newcliente_OLD" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-primary" id="btn_guardarclientenuevo">Guardar</button>
    </div>
  </div>
</div>
</div>
