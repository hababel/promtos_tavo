...
<div class="container-fluid">
	...
	<div class="container">
		<form class="row g-3 mt-2" action="<?php echo URL_PATH ?>usuarios/add_newuser" method="post" id="form_newuser" name="form_newuser">

			<input type="hidden" name="input_tecnico" id="input_tecnico" value="<?php echo $tecnico; ?>">
			<input type="hidden" name="newuser_token" id="newuser_token" value="<?php echo $newuser_token; ?>">
			...
			<div class="<?php echo (($tecnico) ? 'col-md-4' : 'col'); ?>" style="background-color: #F8F9FA;display:flex;align-items: center;">
				<div class="custom-control custom-switch ps-5">
					...
					<input type="checkbox" class="custom-control-input input_aftervalidateemail" id="newuser_status" name="newuser_status" checked>
					<label class="custom-control-label text-success" for="newuser_status" id="estadoLabel">Activo</label>
				</div>
			</div>
