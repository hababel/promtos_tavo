		...
		<div class="row container" style="display: flex;justify-content: center; align-items: center;">
			<div>
				<div style="margin-top:0px;margin-bottom: 40px;">
					<h1>APP - PROMTOS</h1>
					<p class="h5"><small>Recuperación contraseña</small></p>
				</div>
				<div class="form-signin w-100 m-auto">
					<form action="<?php echo URL_PATH; ?>login/recoverypass" method="post">

						<div class="input-group mb-3">
							<input class="form-control" type="email" name="recover_email_input" id="recover_email_input" placeholder="usuario@dominio.com" required autocomplete="off" style="margin-bottom:0px;">
							<span class="input-group-text" id="basic-addon1">@</span>
						</div>

						<button class="w-100 btn btn-lg btn-primary" name="forgotemail_form" type="submit">Enviar</button>
